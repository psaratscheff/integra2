...
class PagosControllerTest < ActionController::TestCase
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post :create, pago: { _id: @pago._id, cuentaDestino: @pago.cuentaDestino, cuentaOrigen: @pago.cuentaOrigen, monto: @pago.monto }
    end
  ...
  test "should update pago" do
    patch :update, id: @pago, pago: { _id: @pago._id, cuentaDestino: @pago.cuentaDestino, cuentaOrigen: @pago.cuentaOrigen, monto: @pago.monto }
    assert_redirected_to pago_path(assigns(:pago))
  end
